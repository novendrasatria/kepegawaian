<?php include('page/koneksi.php'); ?>
        ...
        if(isset($_GET['id_divisi'])){
            ...
            $select = mysqli_query($koneksi, "SELECT * FROM pegawai  WHERE divisi_id ='$id_divisi'") or die(mysqli_error($koneksi));
            if(mysqli_num_rows($select) == 0){
				echo '<div class="alert alert-warning">Data Pegawai dalam divisi ini masih kosong kaka.</div>';
				exit();
            }else{
...
<section class="content-header">
      <div class="container-fluid">
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1>Data Pegawai Divisi <?php echo $fetch2['nama_divisi']; ?></h1>
            <?php
            }
		}
    ?>
                  ...
                  <tbody>
                      <?php
                        ...
                        require 'page/koneksi.php';
                         $id_divisi = $_GET['id_divisi'];
                        $row=$koneksi->query("SELECT * FROM pegawai JOIN tb_pangkat ON tb_pangkat.id_pangkat = pegawai.pangkat_id WHERE divisi_id ='$id_divisi'");
