    ...
    <div class="card-body">
        ...
        <div class="form-group">
            <label for="InputPassword">Password</label>
             <p style="color: red">Jika tidak ingin merubah password, silahkan masukkan password lama anda</p>
        ...
        <div class="form-group">
                ...
                <option <?php echo ($row['id_divisi'] == $e['divisi_id'] ? 'selected' : ''); ?> value="<?php echo $row['id_divisi']; ?>"><?php echo $row['nama_divisi']; ?></option>
                <?php } ?>                        
            </select>
        </div>
        <div class="form-group">
