                ...
                <table id="example1" class="table table-bordered table-striped">
                  ...
                  <tbody>
                      ...
                      <tr>
                          ...
                          <td>
                          <a class="btn btn-warning" href="index2.php?page=edit_pensiun2&kode=<?php echo $fetch['NIP'];?>">
                          <i class="fa fa-edit"></i> Edit</a>
                          </a>
                          <a class="btn btn-danger" href="index2.php?page=dok_pensiun2&kode=<?php echo $fetch['NIP'];?>" 
                          onclick="return confirm('Yakin akan menghapus data? ')">
                          <i class="fa fa-trash"></i> Hapus</a>
                          </a>
                          <a class="btn btn-primary" href="page/userpage/proses_unduh_fpensiun2.php?file=<?php echo $name[1]?>">
